...
class _MyHomePageState extends State<MyHomePage> {
  ...
  TextEditingController titleController =
      TextEditingController(text: "Welcome to Ecodesk!");
                    ...
                    Wrap(
                      children: [
                        ElevatedButton.icon(
                          ...
                          onPressed: () {
                            launchUrlString(
                                "https://github.com/ecodesk-io/ecodesk_flutter");
                          },
                        ...
                        ElevatedButton.icon(
                          ...
                          onPressed: () {
                            launchUrlString(
                                "https://pub.dev/packages/ecodesk_flutter");
                          },
                          label: Text(
                            "View the Package",
            ...
            child: Visibility(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: EcodeskWidget(
                    props: EcodeskProps(
                      accountId: "4e759307-64f4-4a73-a5fb-40192831ed6d",
                      ...
                      style: EcodeskStyle(primaryColor: color),
                      customer: EcodeskCustomerMetadata(
                        email: "admin@ecodesk.io",
                        externalId: "123",
                      ),
                    ),
                  ),
