...
/// Returns the webview which contains the chat. To use it simply call EcodeskWidget(), making sure to add the props!
class EcodeskWidget extends StatefulWidget {
  /// Initialize the props that you will pass on EcodeskWidget.
  final EcodeskProps props;
  ...
  @override
  State<EcodeskWidget> createState() => _EcodeskWidgetState();
}

class _EcodeskWidgetState extends State<EcodeskWidget> {
  bool _connected = false;
  PhoenixSocket? _socket;
  PhoenixChannel? _channel;
  PhoenixChannel? _conversationChannel;
  EcodeskCustomer? _customer;
  ...
  @override
  void didUpdateWidget(EcodeskWidget oldWidget) {
  ...
  void setCustomer(EcodeskCustomer c, {rebuild = false}) {
    if (_customer != c) {
      _customer = c;
      if (rebuild) setState(() {});
    }
