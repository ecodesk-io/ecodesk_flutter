...
import 'package:ecodesk_flutter/utils/fileInteraction/native_file_picker.dart';
import 'package:ecodesk_flutter/utils/fileInteraction/web_file_picker.dart';
...
class SendMessage extends StatefulWidget {
  ...
  final EcodeskCustomer? customer;
  ...
  final List<EcodeskMessage>? messages;
  final bool? sending;
...
class _SendMessageState extends State<SendMessage> {
  ...
  void _onUploadSuccess(List<EcodeskAttachment> attachments) {
