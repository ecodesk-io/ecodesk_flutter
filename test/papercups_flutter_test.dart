...
import 'package:ecodesk_flutter/utils/utils.dart';
...
void main() {
  const props = EcodeskProps(
    accountId: 'account_id',
    customer: EcodeskCustomerMetadata(externalId: 'external_id'),
  );
  final customer = EcodeskCustomer(
    id: 'id',
    createdAt: parseDateFromUTC('2020-12-31T22:19:52.644532'),
    email: 'email@ecodesk.com',
  ...
  group("Props", () {
    ...
    test('are loaded correctly', () {
      props = const EcodeskProps(
          ...
          baseUrl: "app.ecodesk.io",
          style: EcodeskStyle(primaryColor: Color(0x00ffffff)),
  ...
  group("Customer Metadata", () {
    EcodeskCustomerMetadata cm;
    test('default values', () {
      cm = const EcodeskCustomerMetadata();
  ...
  group('getCustomerDetails', () {
    test('returns a Customer object on success', () async {
      ...
      final EcodeskCustomer c = await getCustomerDetails(
        props,
        customer,
        sc,
        client: client,
  ...
  group('getCustomerDetailsFromMetadata', () {
    test('returns a Customer object on success', () async {
      ...
      final EcodeskCustomer c = await getCustomerDetailsFromMetadata(
        props,
        customer,
        sc,
        client: client,
